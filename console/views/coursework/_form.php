...
<div class="coursework-form">
    ...
    <?= $form->field($model, 'test_1')->textInput() ?>

    <?= $form->field($model, 'test_2')->textInput() ?>

    <?= $form->field($model, 'assignment_1')->textInput() ?>

    <?= $form->field($model, 'assignment_2')->textInput() ?>

    <?= $form->field($model, 'class_practical')->textInput() ?>

    <?= $form->field($model, 'final_practical')->textInput() ?>

    <?= $form->field($model, 'ppb')->textInput() ?>

    <?= $form->field($model, 'portifolio')->textInput() ?>
