...
//    }
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($user_category=='staff'){
                ...
                Yii::$app->session->setFlash('danger','<span class="fa fa-warning"> Sorry!  Only student are allowed here</span>');
    ...
    public function actionRequestPasswordReset()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($model->sendEmail()) {
                Yii::$app->session->setFlash('success', 'Request Sent Successfully!! </br>Check your email for further instructions.');
