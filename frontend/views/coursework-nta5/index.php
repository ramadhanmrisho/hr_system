...
$dataProvider = new ActiveDataProvider(['query'=>\common\models\CourseworkNta5::find()->where(['student_id'=>Yii::$app->user->identity->user_id,'semester_id'=>$semester_1])])
...
<div class="table-responsive">
    ...
    $dataProvider = new ActiveDataProvider(['query'=>\common\models\CourseworkNta5::find()->where(['student_id'=>Yii::$app->user->identity->user_id,'semester_id'=>$semester_2])])
