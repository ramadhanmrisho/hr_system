...
/**
 * This is the model class for table "coursework_nta6".
 *
 * @property int $id
 ...
 */
class CourseworkNta6 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['created_at', 'updated_at'], 'safe'],
              [['cat_1p', 'cat_2p', 'assignment_1p', 'assignment_2p','practical_2p', 'practicalp', 'ppbp','nta_level','delivery_book'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'practical' => 'Practical/Oral Exam/Clinical',
            'ppb' => 'PPB',
            'delivery_book'=>'Delivery Book',
            'practical_2' => 'Case Study/Portfolio',
