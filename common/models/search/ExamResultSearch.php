...
/**
 * ExamResultSearch represents the model behind the search form of `common\models\ExamResult`.
 */
class ExamResultSearch extends ExamResult
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'student_id', 'academic_year_id', 'nta_level', 'course_id', 'semester_id', 'module_id', 'final_exam_id', 'grade_id', 'created_by','points'], 'integer'],
            [['coursework', 'total_score','final_exam_score'], 'number'],
            [['remarks', 'category', 'status', 'created_at', 'updated_at'], 'safe'],
        ];
    }
