...
<div class="test-form">
        ...
        <fieldset>
            ...
            <div class="col-md-4">
                ...
                <?= $form->field($model, 'category')->dropDownList([ 'Test 1 (CAT 1)' => 'Test 1 (CAT 1)', 'Test 2 (CAT 2)' => 'Test 2 (CAT 2)', ], ['prompt' => '']) ?>
            </div>
            ...
            <div class="form-group">
                <?= Html::submitButton($model->isNewRecord?'<span class="fa fa-cloud-upload">Upload Results</span>':'<span class="fa fa-pencil-square-o">Save Changes</span>', ['class' => 'btn btn-success pull-right',
                    'data'=>['confirm'=>'Are you sure you want to Upload Test Results',
                        'method'=>'post']]) ?>
            </div>
        </fieldset>
        <?php ActiveForm::end(); ?>
