...
<div class="student-form">
    ...
    <?= $form->field($model, 'year_of_study_id')->widget(Select2::className(),             ['data'=>\yii\helpers\ArrayHelper::map(\common\models\YearOfStudy::find()->all(),'id','name'),             'options'=>['placeholder'=>'--Select--']]) ?>
    ...
    <?= $form->field($model, 'department_id')->widget(Select2::className(),             ['data'=>\yii\helpers\ArrayHelper::map(\common\models\Department::find()->all(),'id','name'),             'options'=>['placeholder'=>'--Select--']]) ?>
