...
<div class="nta4-form">
    ...
    <fieldset>
        <div class="col-md-4">
            <?= $form->field($model, 'course_id')->widget(\kartik\select2\Select2::className(),['data'=>\yii\helpers\ArrayHelper::map(\common\models\Course::find()->where(['nta_level'=>'4'])->all(),'id','course_name'),'options'=>['placeholder'=>'--Select Course--']]) ?>
