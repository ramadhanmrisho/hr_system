...
$this->title = 'PAYROLL TOTAL COST  FOR THE  MONTH OF '.strtoupper($monthName).' '.$year;
...
<div class="payroll-transactions-index">
    ...
    $columns = [
        ...
        [
            ...
            'footer' => Yii::$app->formatter->asDecimal($totalNssf),'label'=>'NSSF 10% EMP'
        ],
        ...
        [
            ...
            'footer' => Yii::$app->formatter->asDecimal($totalSdl),'label'=>'SDL 3.5%'
        ],
...
<div class="payroll-info">
    <div class="payroll-admin">
        <strong>Payroll Administrator:</strong> .....................................
    </div>
<br>
    <div class="finance-manager">
        <strong>Finance & Administration Manager:</strong> .............................
    </div>
<br>
