...
<div class="btn-primary" style=" font-weight: bold;font-family: 'Tahoma';color: whitesmoke;">
    <br>
    <h4 align="center">NTA 5 COURSEWORK SCORES</h4>
...
$dataProvider = new ActiveDataProvider(['query'=>\common\models\CourseworkNta5::find()->where(['staff_id'=>Yii::$app->user->identity->user_id,'semester_id'=>$semester_1])])
...
//            'staff_id',
    ...
    $dataProvider = new ActiveDataProvider(['query'=>\common\models\CourseworkNta5::find()->where(['staff_id'=>Yii::$app->user->identity->user_id,'semester_id'=>$semester_2])])
