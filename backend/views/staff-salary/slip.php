...
<table class="table table-bordered" style="border:1px solid black ;border-collapse: collapse; width: 100%">
    ...
    <tr  style="border:1px solid black;">
        <td style="border:1px solid black;"  colspan="2" >Employee Name: <?php echo $staff?> <br> <br>Employee Number: <?php echo $staff_number?> <br><br> Date joining:<?php echo $date_joining?></td>
