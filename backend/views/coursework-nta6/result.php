    ...
    <div class="col-md-12" align="center">
        ...
        <table class="table table-bordered" style="border:1px solid black; width: 100%;font-size:x-small">
            <tr>
                ...
                <td style="font-family: Cambria;font-size:x-small"><b>NTA LEVEL: <b style="color: dodgerblue"><?php echo  '6'?></b></td>
        ...
        <table class="table table-bordered" style="border:2px solid black; width: 100%;font-size:x-small;padding: 0">
                    ...
                    <td  style="border:1px solid black; padding: 0">
                        <table class="table table-bordered" style="border:2px ; width: 100%; padding: 0">
                            ...
                            <tr style="padding-left: unset">
                                ...
                                <td style="border:1px solid black; width:50px">Portfolio/R Proposal</td>
                                <td style="border:1px solid black; width:50px">D Book</td>
            ...
            <?php
            $student_results= CourseworkNta6::find()->where(['academic_year_id'=>$model->academic_year_id,'course_id'=>$model->course_id,'semester_id'=>$model->semester_id])->groupBy(['student_id'])->all();
            $counter=CourseworkNta6::find()->where(['academic_year_id'=>$model->academic_year_id,'course_id'=>$model->course_id,'semester_id'=>$model->semester_id])->groupBy(['student_id'])->count();


            $x=1;
            foreach ($student_results as $st){

                $student_subjects=CourseworkNta6::find()->where(['student_id'=>$st['student_id'],'academic_year_id'=>$model->academic_year_id,'course_id'=>$model->course_id,'semester_id'=>$model->semester_id])->orderby(['created_at' => SORT_DESC])->all();
                        ...
                        <td  style="border:1px solid black;padding: 0">
                            <table class="table" style="border:2px ; padding: 0">
                                <tr style="padding-left:0">
                                    ...
                                    <td style="border:1px solid black; width: 50px"><?= !empty($subject['practical_2'])?$subject['practical_2']:'-'?></td>
                                    <td style="border:1px solid black; width: 50px"><?= $subject['delivery_book']?></td>
